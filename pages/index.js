...
import { Select, Button, Field, InputTextUncontrolled } from '../components/alheimsins'
import { FaExternalLink } from 'react-icons/lib/fa'
import ISO6391 from 'iso-639-1'
import { getInfo } from 'b5-johnson-120-ipip-neo-pi-r'
import { setItem } from '../lib/localStorageStore'
      ...
      <div style={{ textAlign: 'left', margin: 'auto', fontSize: '14px', width: '100%' }}>
        ...
        <form onSubmit={startTest}>
          ...
          <Field name='Full Name'>
            <InputTextUncontrolled name='fullName' placeholder='Full name' />
          </Field>
